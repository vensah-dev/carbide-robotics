    ...
    // THIS IS h-[calc(100vh-73px)] BECAUSE THE NAVBAR HEIGHT IS 73px. THIS ENSURES THE HERO SECTION TAKES UP THE FULL VIEWPORT HEIGHT MINUS THE NAVBAR.  
      <section className="flex items-center px-8 text-left h-[calc(100vh-73px)] relative">
        ...
        <div className="max-w-6xl z-10">
          ...
          <h1 className="text-5xl md:text-8xl font-bold text-background-primary mb-3 leading-[1.15] animate-fade-in-up">
            STEM Accelerator Programme
          </h1>

          <p className="md:max-w-2xl w-[83vw] text-base md:text-xl text-background-secondary mb-8 leading-relaxed w-[70%] animate-fade-in-up animation-delay-300">
